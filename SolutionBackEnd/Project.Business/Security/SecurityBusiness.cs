...
namespace Milano.BackEnd.Business.Security
{
    ...
    public class SecurityBusiness : BaseBusiness
    {
        ...
        /// <returns></returns>
        public ResponseBussiness<UserResponse> Login(int numberEmployee, string password, int numberAttempts, string ip)
        {
            return tryCatch.SafeExecutor(() =>
            {
                return repository.Login(numberEmployee, password, numberAttempts, ip);
            });
        }
